...
'\n<form action="' + (LassoApp_Link:'indexAdmin.lasso') + '?pg=' + (Encrypt_BlowFish: -seed=(dCoreModTag_core_appinfo->getCrypto:'1'), 'Adfiler') + '" method="post">';


	include:(LassoApp_Link:'adm_file_view_layout.lasso');
	
	'\n<input type="hidden" name="filenum" value="' + (var:'filenum') + '">';
	'\n<input type="hidden" name="fcatnum" value="' + (Encrypt_BlowFish: -seed=(dCoreModTag_core_appinfo->getCrypto:'1'),(#dCoreFiles->get:3->get:1->get:6)) + '">';
