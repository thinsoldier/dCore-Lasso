...
if: 	((var:'day')->size > 0) &&((var:'month')->size > 0) &&	((var:'year')->size > 0);
	
	local:'passedDate' = ((var:'day') +'/'+ (var:'month')+'/'+ (var:'year'));
	local:'getDate' = (date: (#passedDate), -format='%d/%m/%Y');
...
dCoreModTag_hd746Grey:'Displaying: ' +(date_format: (#searchDate), -format='%d %B %Y'),-encodenone;
...
loop: 24;
	...
	'<td align="center" nowrap height="15" width="75">' + (dCoreAPI_PercentOf: -int1=(local:'HourStat_' + (loop_count)),-int2=(#getDayHits)) + '%</td>';
	
	if: (dCoreAPI_PercentOf: -int1=(local:'HourStat_' + (loop_count)),-int2=(#getDayHits)) > 0;
		'<td align="left" nowrap valign="middle" bgcolor="#ffffff" width="100%"><img src="dCoreIMG_core/Statgraphstart.gif" border="0" height="15"><img src="dCoreIMG_core/Statgraphmiddle.gif" border="0" height="15" ' + 'width="' + (dCoreAPI_PercentOf: -int1=(local:'HourStat_' + (loop_count)),-int2=(#getDayHits)) + '%"></td>';
...
'<tr><td colspan=2>';
dCoreModTag_hd241Grey:'Statistical Calendar',-encodenone;

dCoreModAPI_core_StatsCalendar;
'</td>';
'</tr>';
'<tr><td colspan=2>';
...
'<td>';
	...
	if: (dCoreAPI_PercentOf: -int1=(#windowsOS),-int2=(#statsOSsearch->get:2)) > 0;
		...
		'<img src="dCoreIMG_core/statgraphstart.gif" border="0" height="15">';
		'<img src="dCoreIMG_core/statgraphmiddle.gif" border="0" height="15" ' + 'width="' + (dCoreAPI_PercentOf: -int1=(#windowsOS),-int2=(#statsOSsearch->get:2)) + '%">';
		//'<img src="dCoreIMG_core/statgraphend.gif" border="0" height="15">';
		'</td>';
...
'<td>';
	...
	if: (dCoreAPI_PercentOf: -int1=(#macOS),-int2=(#statsOSsearch->get:2)) > 0;
		...
		'<img src="dCoreIMG_core/statgraphstart.gif" border="0" height="15">';
		'<img src="dCoreIMG_core/statgraphmiddle.gif" border="0" height="15" ' + 'width="' + (dCoreAPI_PercentOf: -int1=(#macOS),-int2=(#statsOSsearch->get:2)) + '%">';
		//'<img src="dCoreIMG_core/statgraphend.gif" border="0" height="15">';
		'</td>';
		'<td valign="middle" nowrap>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
	else;
...
'<td>';
	...
	if: (dCoreAPI_PercentOf: -int1=(#linuxOS),-int2=(#statsOSsearch->get:2)) > 0;
		...
		'<img src="dCoreIMG_core/statgraphstart.gif" border="0" height="15">';
		'<img src="dCoreIMG_core/statgraphmiddle.gif" border="0" height="15" ' + 'width="' + (dCoreAPI_PercentOf: -int1=(#linuxOS),-int2=(#statsOSsearch->get:2)) + '%">';
...
'<td>';
	...
	if: (dCoreAPI_PercentOf: -int1=(#otherOS),-int2=(#statsOSsearch->get:2)) > 0;
		...
		'<img src="dCoreIMG_core/statgraphstart.gif" border="0" height="15">';
		'<img src="dCoreIMG_core/statgraphmiddle.gif" border="0" height="15" ' + 'width="' + (dCoreAPI_PercentOf: -int1=(#otherOS),-int2=(#statsOSsearch->get:2)) + '%">';
		//'<img src="dCoreIMG_core/graphend.gif" border="0" height="15">';
		'</td>';
		'<td valign="middle" nowrap>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
	else;
...
'<td>';
	...
	if: (dCoreAPI_PercentOf: -int1=(#Mozilla4),-int2=(#statsOSsearch->get:2)) > 0;
		...
		'<img src="dCoreIMG_core/statgraphstart.gif" border="0" height="15">';
		'<img src="dCoreIMG_core/statgraphmiddle.gif" border="0" height="15" ' + 'width="' + (dCoreAPI_PercentOf: -int1=(#Mozilla4),-int2=(#statsOSsearch->get:2)) + '%">';
		//'<img src="dCoreIMG_core/graphend.gif" border="0" height="15">';
		'</td>';
		'<td valign="middle" nowrap>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
	else;
...
'<td>';
	...
	if: (dCoreAPI_PercentOf: -int1=(#Mozilla5),-int2=(#statsOSsearch->get:2)) > 0;
		...
		'<img src="dCoreIMG_core/statgraphstart.gif" border="0" height="15">';
		'<img src="dCoreIMG_core/statgraphmiddle.gif" border="0" height="15" ' + 'width="' + (dCoreAPI_PercentOf: -int1=(#Mozilla5),-int2=(#statsOSsearch->get:2)) + '%">';
		//'<img src="dCoreIMG_core/graphend.gif" border="0" height="15">';
		'</td>';
		'<td valign="middle" nowrap>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
	else;
