...
'\n<form action="' + (LassoApp_Link:'indexAdmin.lasso') + '?pg=' + (Encrypt_BlowFish: -seed=(dCoreModTag_core_appinfo->getCrypto:'1'), 'Acugr') + '" method="post">';

	include:(LassoApp_Link:'adm_userGroup_ae_layout.lasso');
	
	'\n<input type="hidden" name="num" value="' + (Keyfield_value) + '">';
	'\n<table border="0" width="746">';
		
		'\n<tr>';
		'\n<td valign="top" width="500">';
			'\n<input type="submit"  value="Create User Group">';
