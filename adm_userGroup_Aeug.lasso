...
'\n<form action="' + (LassoApp_Link:'indexAdmin.lasso') + '?pg=' + (Encrypt_BlowFish: -seed=(dCoreModTag_core_appinfo->getCrypto:'1'), 'Aeugr') + '" method="post">';
	...
	'\n<table border="0" width="746">';
		...
		'\n<td valign="top" width="500">';
			'\n<input type="submit"  value="Update User Group">';
