...
'\n<form enctype="multipart/form-data" action="' + (LassoApp_Link:'indexAdmin.lasso') + '?pg=' + (Encrypt_BlowFish: -seed=(dCoreModTag_core_appinfo->getCrypto:'1'), 'Acfcatr') + '" method="post"  name="con_form">';
	...
	include:(LassoApp_Link:'adm_fileCat_ae_layout.lasso');
		...
		'\n<td valign="top" width="500">';
			'\n<input type="submit"  value="Create File Category">';
