...
'\n<form enctype="multipart/form-data" action="' + (LassoApp_Link:'indexAdmin.lasso') + '?pg=' + (Encrypt_BlowFish: -seed=(dCoreModTag_core_appinfo->getCrypto:'1'), 'Aeur') + '" method="post">';
	...
	'\n<input type="hidden" name="master" value="' + (#dCoreUserRecord->get:3->get:1->get:2) + '">';
