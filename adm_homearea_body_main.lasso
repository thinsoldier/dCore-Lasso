...
if: (#dCoreHomepage->get:2) < 1;
	var:'title' = 'Welcome';
	
	local: 'dCoreInsertFields' 	= 	dCoreModTag_moduleDb->(Insert: (dCoreModTag_coreConfig->database),'dCoreModdb_core_homepage',(dcoremodtag_core_homepage->setLocal));
